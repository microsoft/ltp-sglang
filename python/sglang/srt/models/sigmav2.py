...
class SigmaV2MoeAttention(nn.Module):
    def __init__(
        self,
        hidden_size: int,
        num_heads: int,
...
class SigmaV2MoeDecoderLayer(nn.Module):
    def __init__(
        self,
        config: SigmaV2MoeConfig,
        layer_id: int,
        ...
        self.self_attn = SigmaV2MoeAttention(
        ...
        self.mlp = SigmaV2MoeSparseMoeBlock(
            config=config,
            quant_config=quant_config,
...
class SigmaV2ForCausalLM(nn.Module):
