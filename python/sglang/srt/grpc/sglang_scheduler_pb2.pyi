...
class SamplingParams(_message.Message):
    ...
    def __init__(
        ...
        stop_token_ids: _Optional[_Iterable[int]] = ...,
        skip_special_tokens: bool = ...,
        spaces_between_special_tokens: bool = ...,
        regex: _Optional[str] = ...,
        json_schema: _Optional[str] = ...,
        ebnf_grammar: _Optional[str] = ...,
        structural_tag: _Optional[str] = ...,
        n: _Optional[int] = ...,
        min_new_tokens: _Optional[int] = ...,
        ignore_eos: bool = ...,
        no_stop_trim: bool = ...,
        stream_interval: _Optional[int] = ...,
        logit_bias: _Optional[_Mapping[str, float]] = ...,
        custom_params: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
    ) -> None: ...
...
class DisaggregatedParams(_message.Message):
    ...
    def __init__(
        self,
        bootstrap_host: _Optional[str] = ...,
        bootstrap_port: _Optional[int] = ...,
        bootstrap_room: _Optional[int] = ...,
    ) -> None: ...
...
class GenerateRequest(_message.Message):
    ...
    def __init__(
        ...
        tokenized: _Optional[_Union[TokenizedInput, _Mapping]] = ...,
        mm_inputs: _Optional[_Union[MultimodalInputs, _Mapping]] = ...,
        sampling_params: _Optional[_Union[SamplingParams, _Mapping]] = ...,
        return_logprob: bool = ...,
        logprob_start_len: _Optional[int] = ...,
        top_logprobs_num: _Optional[int] = ...,
        token_ids_logprob: _Optional[_Iterable[int]] = ...,
        return_hidden_states: bool = ...,
        disaggregated_params: _Optional[_Union[DisaggregatedParams, _Mapping]] = ...,
        custom_logit_processor: _Optional[str] = ...,
        timestamp: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        log_metrics: bool = ...,
        input_embeds: _Optional[_Iterable[float]] = ...,
        lora_id: _Optional[str] = ...,
        data_parallel_rank: _Optional[int] = ...,
        stream: bool = ...,
    ) -> None: ...
...
class MultimodalInputs(_message.Message):
    ...
    def __init__(
        ...
        video_urls: _Optional[_Iterable[str]] = ...,
        audio_urls: _Optional[_Iterable[str]] = ...,
        processed_features: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
        image_data: _Optional[_Iterable[bytes]] = ...,
        video_data: _Optional[_Iterable[bytes]] = ...,
        audio_data: _Optional[_Iterable[bytes]] = ...,
        modalities: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
...
class GenerateResponse(_message.Message):
    ...
    def __init__(
        self,
        request_id: _Optional[str] = ...,
        chunk: _Optional[_Union[GenerateStreamChunk, _Mapping]] = ...,
        complete: _Optional[_Union[GenerateComplete, _Mapping]] = ...,
        error: _Optional[_Union[GenerateError, _Mapping]] = ...,
    ) -> None: ...
...
class GenerateStreamChunk(_message.Message):
    ...
    def __init__(
        ...
        output_logprobs: _Optional[_Union[OutputLogProbs, _Mapping]] = ...,
        hidden_states: _Optional[_Iterable[float]] = ...,
        input_logprobs: _Optional[_Union[InputLogProbs, _Mapping]] = ...,
        index: _Optional[int] = ...,
    ) -> None: ...
...
class GenerateComplete(_message.Message):
    ...
    def __init__(
        ...
        cached_tokens: _Optional[int] = ...,
        output_logprobs: _Optional[_Union[OutputLogProbs, _Mapping]] = ...,
        all_hidden_states: _Optional[_Iterable[_Union[HiddenStates, _Mapping]]] = ...,
        matched_token_id: _Optional[int] = ...,
        matched_stop_str: _Optional[str] = ...,
        input_logprobs: _Optional[_Union[InputLogProbs, _Mapping]] = ...,
        index: _Optional[int] = ...,
    ) -> None: ...
...
class GenerateError(_message.Message):
    ...
    def __init__(
        ...
        http_status_code: _Optional[str] = ...,
...
class OutputLogProbs(_message.Message):
    ...
    def __init__(
        self,
        token_logprobs: _Optional[_Iterable[float]] = ...,
        token_ids: _Optional[_Iterable[int]] = ...,
        top_logprobs: _Optional[_Iterable[_Union[TopLogProbs, _Mapping]]] = ...,
    ) -> None: ...
...
class InputLogProbs(_message.Message):
    ...
    def __init__(
        self,
        token_logprobs: _Optional[_Iterable[_Union[InputTokenLogProb, _Mapping]]] = ...,
        token_ids: _Optional[_Iterable[int]] = ...,
        top_logprobs: _Optional[_Iterable[_Union[TopLogProbs, _Mapping]]] = ...,
    ) -> None: ...
...
class EmbedRequest(_message.Message):
    ...
    def __init__(
        ...
        sampling_params: _Optional[_Union[SamplingParams, _Mapping]] = ...,
        log_metrics: bool = ...,
        token_type_ids: _Optional[_Iterable[int]] = ...,
        data_parallel_rank: _Optional[int] = ...,
        is_cross_encoder: bool = ...,
...
class EmbedResponse(_message.Message):
    ...
    def __init__(
        self,
        request_id: _Optional[str] = ...,
        complete: _Optional[_Union[EmbedComplete, _Mapping]] = ...,
        error: _Optional[_Union[EmbedError, _Mapping]] = ...,
    ) -> None: ...
...
class EmbedComplete(_message.Message):
    ...
    def __init__(
        self,
        embedding: _Optional[_Iterable[float]] = ...,
        prompt_tokens: _Optional[int] = ...,
        cached_tokens: _Optional[int] = ...,
        embedding_dim: _Optional[int] = ...,
        batch_embeddings: _Optional[_Iterable[_Union[Embedding, _Mapping]]] = ...,
    ) -> None: ...
...
class Embedding(_message.Message):
    ...
    index: int
    def __init__(
        self, values: _Optional[_Iterable[float]] = ..., index: _Optional[int] = ...
    ) -> None: ...
...
class AbortRequest(_message.Message):
    ...
    reason: str
    def __init__(
        self, request_id: _Optional[str] = ..., reason: _Optional[str] = ...
    ) -> None: ...
...
class UpdateWeightsRequest(_message.Message):
    ...
    def __init__(
        ...
        tensor_data: _Optional[bytes] = ...,
        remote_url: _Optional[str] = ...,
        weight_name: _Optional[str] = ...,
    ) -> None: ...
...
class GetInternalStateResponse(_message.Message):
    ...
    def __init__(
        self, state: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...
    ) -> None: ...
...
class GetModelInfoResponse(_message.Message):
    ...
    def __init__(
        ...
        tokenizer_path: _Optional[str] = ...,
        is_generation: bool = ...,
        preferred_sampling_params: _Optional[str] = ...,
        weight_version: _Optional[str] = ...,
        served_model_name: _Optional[str] = ...,
        max_context_length: _Optional[int] = ...,
        vocab_size: _Optional[int] = ...,
        supports_vision: bool = ...,
        model_type: _Optional[str] = ...,
        eos_token_ids: _Optional[_Iterable[int]] = ...,
        pad_token_id: _Optional[int] = ...,
        bos_token_id: _Optional[int] = ...,
        max_req_input_len: _Optional[int] = ...,
        architectures: _Optional[_Iterable[str]] = ...,
        id2label_json: _Optional[str] = ...,
        num_labels: _Optional[int] = ...,
    ) -> None: ...
...
class GetServerInfoResponse(_message.Message):
    ...
    def __init__(
        self,
        server_args: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
        scheduler_info: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
        active_requests: _Optional[int] = ...,
        is_paused: bool = ...,
        last_receive_timestamp: _Optional[float] = ...,
        uptime_seconds: _Optional[float] = ...,
        sglang_version: _Optional[str] = ...,
